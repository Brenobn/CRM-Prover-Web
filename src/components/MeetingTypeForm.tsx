...
export function MeetingTypeForm({ onSubmit, initialData }: MeetingTypeFormProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col justify-between h-full space-y-8">
        <div className="space-y-8">
          ...
          <FormField 
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Descrição do Tipo de Reunião</FormLabel>
                <FormControl>
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <FormDescription>
                    Se desmarcado, este tipo de reunião não aparecerá para seleção.
                  </FormDescription>
                </div>
                <FormControl>
                  <Switch 
