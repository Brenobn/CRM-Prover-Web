...
interface ProposalRefusalReasonFormProps {
  onSubmit: (Values: z.infer<typeof formSchema>) => void
  initialData?: z.infer<typeof formSchema>
}

export function ProposalRefusalReasonForm({ onSubmit, initialData }: ProposalRefusalReasonFormProps) {
  ...
  useEffect(() => {
    if(initialData) {
      ...
      form.reset({ descrição: "", ativo: true })
    }
  }, [initialData, form])
          ...
          <FormField 
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Ex: Recusado" {...field}/>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <FormDescription>
                    Se desmarcado, esta motivo não aparecerá para seleção.
                  </FormDescription>
                </div>
                <FormControl>
                  <Switch 
